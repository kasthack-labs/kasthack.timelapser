...
namespace kasthack.TimeLapser.Core.Impl.Recorders
{
        ...
        ILogger<Recorder> Logger) : IRecorder
    {
        ...
        /// <summary>
        /// timeouts don't include process switching.
        /// </summary>
        private const int MinimumInterval = 10;
            ...
            try
            {
                ...
                while (this.Recording)
                {
                    ...
                    for (var i = 0L; (splitIntervalInFrames == null || i < splitIntervalInFrames) && this.Recording; i++)
                    {
                        ...
                        IPooledFrame currentFrame = null;
                        try
                        {
                            framesWritten++;
                            ...
                            if (dropNextNFrames > 0 && currentFrame != null)
                            {
                                ...
                                outstream.WriteVideoFrame(currentFrame.Value);
                                continue;
                            }
